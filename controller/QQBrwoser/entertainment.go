...
// 娱乐领域领域
func QQEntertainmentdeile(c *gin.Context) {
	db := model.Dbinit()
	var ucSh []QQmodel.QQEntertainment
	var cmt []QQmodel.QQEntertainment
	...
	a := total/15 + 1
	if currentPage > a {
		renovate := "/user/auth/qqEntertainmentdeile?cmt=&pageSize=15&currentPage=1"
		c.HTML(200, "QQyile.html", gin.H{
